    ...
    t.fn.bxSlider = function(n) {
        ...
        var a = t(window).width()
          ...
          , q = function(e) {
            ...
            void o.pagerEl.html("<strong>" + (e + 1) + "</strong>" + o.settings.pagerShortSeparator + i)) : (o.pagerEl.find("a").removeClass("active"),
          ...
          , V = function(t) {
            ...
            "fade" == o.settings.mode) {
                (s = Math.abs(o.touch.start.x - o.touch.end.x)) >= o.settings.swipeThreshold && (o.touch.start.x > o.touch.end.x ? r.goToNextSlide() : r.goToPrevSlide(),
                r.stopAuto())
            } else {
                var s = 0;
            ...
            if (!o.working && o.active.index != e)
                ...
                "fade" == o.settings.mode)
                    ...
                    if (!o.settings.infiniteLoop && o.carousel && o.active.last)
                        if ("horizontal" == o.settings.mode) {
                            n = (l = o.children.eq(o.children.length - 1)).position(),
                            s = o.viewport.width() - l.outerWidth()
                        } else {
